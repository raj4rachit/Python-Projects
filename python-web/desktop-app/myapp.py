...
logged_in = False
stop_thread = False
api_host = "https://hrms.schedulesoftware.net/api"
...
def create_login_window():
    global login_window, login_message_var, background_image, username_entry, password_entry
    try:
...
def start_monitoring_window():
    global monitoring_window, login_window, user_data, background_image

    login_window.withdraw()  # Hide the login window

    monitoring_window = tk.Tk()
...
def login():
    global logged_in, login_message_var, user_data, username_entry, password_entry
...
def monitor_activity():
    while not stop_thread:
        if logged_in:
            ...
            # For example: screenshot.save("screenshot.png")
